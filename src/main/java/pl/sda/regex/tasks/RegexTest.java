...
public class RegexTest {
    public static void main(String[] args) {
        ...
        System.out.println(RegexUtil.isValidHttpAddress("http://example.com"));
        System.out.println(RegexUtil.isValidHttpAddress("http://janusz.plvs"));
        System.out.println(RegexUtil.isValidHttpAddress("http://janusz.2.pl"));
        System.out.println(RegexUtil.isValidHttpAddress("htp://janusz.pl"));
   }
}
