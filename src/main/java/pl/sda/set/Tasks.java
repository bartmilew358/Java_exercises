...
//        Car car1 = new Car("ford", "black", 5042);
//        Car car2 = new Car("ford", "black", 5040);
//        Car car3 = new Car("ford", "black", 5041);
//        Car car4 = new Car("ford", "black", 5048);
//        Car car5 = new Car("ford", "black", 5040);
//
//        setOfCars(car1, car2, car3, car4, car5);
